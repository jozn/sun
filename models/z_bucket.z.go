...
// Bucket represents a row from 'ms.bucket'.
...
// BucketByBucketId retrieves a row from 'ms.bucket' as a Bucket.
//
// Generated from index 'bucket_BucketId_pkey'.
func BucketByBucketId(db XODB, bucketId int) (*Bucket, error) {
	var err error
