...
type PB_PushDirectLogsMany_Flat struct {
...
func(m *PB_PushDirectLogsMany)ToFlat() *PB_PushDirectLogsMany_Flat {
r := &PB_PushDirectLogsMany_Flat{
...
func(m *PB_PushDirectLogsMany_Flat)ToPB() *PB_PushDirectLogsMany {
r := &PB_PushDirectLogsMany{
