...
/////////////////// RpcMsgs  -  EmptyRPC_RpcMsgs /////////////////////
type EmptyRPC_RpcMsgs int

var Empty_RPC_RpcMsgs_Sample = EmptyRPC_RpcMsgs(0)

func (EmptyRPC_RpcMsgs) UploadNewMsg(i *PB_Message, p RPC_UserParam) (*PB_ResRpcAddMsg, error) {
	return nil, nil
}
