...
func (*PB_ChatView) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{0} }
...
func (*PB_MessageView) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{1} }
...
func (*PB_MessageFileView) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{2} }
...
func (*PB_UserView) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{3} }
...
func init() { proto.RegisterFile("pb_views.proto", fileDescriptor7) }
