...
func (*PB_UserParam_CheckUserName2) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{0} }
...
func (*PB_UserResponse_CheckUserName2) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{1} }
...
func init() { proto.RegisterFile("pb_rpc_auth2.proto", fileDescriptor5) }
