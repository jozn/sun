...
func (*PB_ReqRpcAddMsg) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{0} }
...
func (*PB_ResRpcAddMsg) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{1} }
...
func init() { proto.RegisterFile("pb_rpc_msgs.proto", fileDescriptor4) }
