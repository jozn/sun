...
func (*PB_MsgsSeenFromClient) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{0} }
...
func (*PB_MsgSeen) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{1} }
...
func (*PB_RequestMsgsSeen) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{2} }
...
func (*PB_ResponseMsgsSeen) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{3} }
...
func init() { proto.RegisterFile("pb_seen_msgs.proto", fileDescriptor7) }
