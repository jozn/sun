...
func (c _StoreImpl) PushMessage_ByPushMessageId(PushMessageId uint) (*PushMessage, bool) {
...
func (c _StoreImpl) PreLoadPushMessage_ByPushMessageIds(PushMessageIds []uint) {
	not_cached := make([]uint, 0, len(PushMessageIds))
