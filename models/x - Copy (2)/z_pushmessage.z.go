...
type PushMessage__ struct {
	PushMessageId uint `json:"PushMessageId"` // PushMessageId -
...
func PushMessageByPushMessageId(db XODB, pushMessageId uint) (*PushMessage, error) {
	var err error
